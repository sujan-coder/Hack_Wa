...
A BLE wearable watch with **Chronos app integration** and **HID password manager**, built on the Seeed XIAO ESP32-C6 with an SSD1306 128×64 OLED.
...
Connect to "Chronos" (or "HackWa-KB" in HID mode) with a BLE UART app like **nRF Connect**, **Serial Bluetooth Terminal**, or **LightBlue**. Send AT-commands to the NUS RX characteristic:
...
### Method 2: Chronos binary protocol

The watch also accepts passwords via the Chronos app's NUS data channel.
